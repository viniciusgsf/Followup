...
import {Container, SubContainer, Content, MainContent, Bplan, Topside, BottomSide, BottomContainer , BottomInputs, ButtonDiv, BplanContent, BplanContentContainer, BplanInfo,
    ScrollbarBplan, BplanItens, BplanCheckbox, BplanBody, BplanButtons, BplanButtonsContent, BplanButtonsDiv, HiddenContent
} from './styles';
                            ...
                            <BottomSide>
                                <BottomContainer>
                                    <BottomInputs>
                                        <label>
                                            <ButtonDiv>
                                            <Input name="businessplan" icon={FiSearch} type="text" placeholder="Bairro"/>
                                            </ButtonDiv>    
                                            <ButtonDiv>
                            ...
                            <BottomSide>
                                <BottomContainer>
                                    <BottomInputs>
                                        <label>
                                            <ButtonDiv>
                                            <Input name="businessplan" icon={FiSearch} type="text" placeholder="Localidade"/>
                                            </ButtonDiv>    
                                            <ButtonDiv>
                                            <Input name="description" icon={FiSearch} type="text" placeholder="Uf"/>
                                            </ButtonDiv>
