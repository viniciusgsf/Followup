...
const AddTreatmentForm: React.FC = () => {
    ...
    return (
      <>
          ...
          <SubContainer>
            <Content>
              <MainContent>
                <TopContent>
                  <Topside>
                    <h4>Cadastrar formas de tratamento</h4>
                  ...
                  <BottomSide>
                    <BottomContainer>
                      <Form ref={formRef} onSubmit={handleSubmit}>                           
                        ...
                        <Input name="name" icon={FaGlobeAmericas} placeholder="Digite a forma de tratamento..." />                       
        ...
        <Alert onClose={handleClose} severity="success" sx={{ width: '100%' }}>
          Forma de tratamento gravado com sucesso.
        </Alert>
      </Snackbar>
      </>
    )
