  ...
  const formRef = useRef<FormHandles>(null);
    ...
    const handleSubmit = useCallback( async (data: CountryFormData) => {
      try {
          ...
          await api.post('/Nationality', data);
          setIsSaved(true)
    ...
    return (
      <>
                  ...
                  <BottomSide>
                    <BottomContainer>
                      <Form ref={formRef} onSubmit={handleSubmit}>                           
                        ...
                        <Input name="name" icon={FiChevronRight} placeholder="Digite a nacionalidade..." />                       
        ...
        <Alert onClose={handleClose} severity="success" sx={{ width: '100%' }}>
          Nacionalidade gravado com sucesso.
        </Alert>
      </Snackbar>
      </>
    )
